...
class LoaderConstant extends StatefulWidget {
  final Color color1;
  final Color color2;
  final Color color3;
  ...
  @override
  _LoaderConstantState createState() => _LoaderConstantState();
}

class _LoaderConstantState extends State<LoaderConstant>
