...
class LoaderMinConstant extends StatefulWidget {
  final Color color1;
  final Color color2;
  final Color color3;
  ...
  LoaderMinConstant(
      {
        this.color1 = ColorConstant.thrirdColor,
        this.color2 = Colors.yellow,
        this.color3 = ColorConstant.colorPrimary
      }
      );

  @override
  _LoaderMinConstantState createState() => _LoaderMinConstantState();
}

class _LoaderMinConstantState extends State<LoaderMinConstant>
